...
let UsersService = class UsersService {
    ...
    async createWithHashedPassword(dto) {
        ...
        const user = (0, user_mapper_1.mapCreateUserDtoToEntity)(dto);
        const saltRounds = 10;
    ...
    async update(id, dto) {
        ...
        (0, user_mapper_1.applyUpdateUserDtoToEntity)(user, dto);
        return this.usersRepo.save(user);
    }
    async softRemove(id) {
        const user = await this.findById(id);
    ...
    async restore(id) {
        ...
        if (!user.deletedAt) {
            throw new common_1.NotFoundException('User is not deleted');
        }
