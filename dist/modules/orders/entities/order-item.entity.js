...
let OrderItem = class OrderItem extends entities_1.BaseEntity {
    orderId;
    ticketTypeId;
    quantity;
    unitPrice;
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => ticket_type_entity_1.TicketType, (ticketType) => ticketType.orderItems),
    (0, typeorm_1.JoinColumn)({ name: 'ticket_type_id' }),
    __metadata("design:type", ticket_type_entity_1.TicketType)
], OrderItem.prototype, "ticketType", void 0);
