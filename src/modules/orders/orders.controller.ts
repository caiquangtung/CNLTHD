...
import { ApiTags, ApiOperation, ApiResponse, ApiBearerAuth, ApiBody, ApiOkResponse, ApiQuery } from '@nestjs/swagger';
...
export class OrdersController {
    ...
    async create(
        ...
        let ipAddr = (req.headers['x-forwarded-for'] as string) || (req as any).socket?.remoteAddress || '127.0.0.1';
        // Normalize IPv6 ::1 to 127.0.0.1 for VNPay compatibility
